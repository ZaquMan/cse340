-- Enum for employee account types
...
-- Correction to GM Hummer's description
UPDATE inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM'
	AND inv_model = 'Hummer';

-- Correction to directory for inventory images/thumbnails
UPDATE inventory
...
-- Add newsletter opt-in to account
ALTER TABLE public.account
  ADD account_newsletter bool DEFAULT FALSE NOT NULL;

-- Add new table for newsletters
CREATE TABLE public.newsletter (
	newsletter_id integer GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	newsletter_published_date date DEFAULT NOW() NOT NULL,
